...
Trust Wallet Agent Kit → portal.trustwallet.com
BNB AI Agent SDK → https://github.com/bnb-chain/bnbagent-sdk
BNB Hack Telegram → https://t.me/+MhiOLT0YUnlmNWFk
 

Disclaimers
Prizes. Organizers reserve the right to withhold prizes if submissions do not meet the quality standards or criteria set for the hackathon. Awards are contingent on the judging panel's evaluation of innovation, functionality, relevance, and overall quality. If no submission sufficiently meets the requirements, prizes may not be awarded.

Third-party services and trading risk. Any use of third-party AI agents, tools, or services is at the participant's own risk. Trading agents act on-chain and can incur real financial loss. If a malfunction, data issue, security incident, or financial loss occurs in connection with such services, contact the relevant provider directly. BNB Chain makes no warranties regarding third-party services and assumes no liability for any direct or indirect losses arising from their use.

Built by BNB Chain, CoinMarketCap, and Trust Wallet.